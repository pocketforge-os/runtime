...
- **`Op`:** `IsPresent=1`, `IsGranted=2`, `Query=3`, `Acquire=4`, `GetCapability=5`,
  ...
  `GetAppearance=11`, `GetAppearanceSource=12`.
...
- **C symbols (17):** `pf_connect`, `pf_connect_descriptor`, `pf_free`, `pf_has_capability`,
  ...
  `pf_preference_bool`, `pf_preference_scalar`, `pf_appearance`, `pf_appearance_source` (full authoritative list in
